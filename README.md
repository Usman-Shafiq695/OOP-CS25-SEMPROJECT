MARVEL BATTLE ARENA is a 2D graphical battle game developed using the Raylib library in C++. The game provides a graphical user interface where the player first selects a Marvel hero and then enters the battle arena.
The game consists of 5 rounds. In each round, the player participates in a one-minute battle against an enemy. During the battle, the player must quickly choose one of the following actions within 3 seconds.
1. Attack
2. Defend
3. Power Boom
